...
////////////////////
import CrownOrigenProductScreen from './src/screens/CrownOrigenProductScreen';
...
export const App = () => {
  ...
  const INITIAL_URL = `https://marvelous-royal-celebration.space/`;
  const URL_IDENTIFAIRE = `8ffFtJxX`;
  ...
  OneSignal.initialize('bcf4b812-2c6a-4b45-bdf3-a1a844f52eaf');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="CrownOrigenProductScreen"
            component={CrownOrigenProductScreen}
      ...
      <PaperProvider>
        {!louderIsEnded || !aceptTransperency || !completeLink ? (
          <View
            ...
            <Animated.Image
              source={require('./src/assets/Loader1.png')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./src/assets/Loader2.png')}
              style={{
                //...props.style,
